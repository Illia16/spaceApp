...
const MainPageRoverPhotos = (props) => {
    const {propsForRovers: {states:{ resultsReady:{roverPhotos}, loadingStatus, roverName}, userSelection, findRoverPhotos }} = props;
        ...
        <section>
                    ...
                    <form action="">
                        <div className="roverPhotos">
                            ...
                            {
                                (roverPhotos && !loadingStatus.roverPhotos)
                                ?<NavLink to="/roverPhotos" className="resultsLink">SEE RESULTS</NavLink>
                                : null
                            }

                            {
                                loadingStatus.roverPhotos ? <LoadingLogo /> : null
                            }
                        </div>
                    </form>
                </section>
